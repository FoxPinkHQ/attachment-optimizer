...
**Version:** 15.0.1.0.1 — **License:** LGPL-3 — **Publisher:** FoxPink — **Validated release available for every Odoo series from 14.0 to 19.0.**
...
> **Roadmap notice:** Pro features are planned and are not included in version 15.0.1.0.1. The Free Edition remains fully usable for safe, verified S3 replication and migration assessment.
