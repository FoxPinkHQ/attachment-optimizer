...
> **Pro release:** Version 18.0.1.0.3 is validated for Odoo 18.0 and priced at US$49 one-time per Odoo major version. Provider-to-provider migration, rate throttling, and cost forecasting are not included in this release.
