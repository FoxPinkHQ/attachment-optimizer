...
**Version:** 15.0.1.0.10 -- **License:** LGPL-3 -- **Publisher:** FoxPink -- Maintained for **Odoo 14.0-19.0** (one validated build per series)
...
```bash
git clone -b 15.0 https://github.com/FoxPinkHQ/attachment-optimizer addons/attachment_optimizer
```
